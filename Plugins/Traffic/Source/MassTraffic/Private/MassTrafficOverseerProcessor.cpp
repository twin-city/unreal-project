...
void UMassTrafficOverseerProcessor::Execute(FMassEntityManager& EntityManager, FMassExecutionContext& Context)
{
	...
	const UZoneGraphSubsystem& LocalZoneGraphSubsystem = Context.GetSubsystemChecked<UZoneGraphSubsystem>(World);
	UMassTrafficSubsystem& LocalMassTrafficSubsystem = Context.GetMutableSubsystemChecked<UMassTrafficSubsystem>(World);
...

	{
		...
		RecyclableTrafficVehicleEntityQuery.ForEachEntityChunk(EntityManager, Context, [&EntityManager, World, this](FMassExecutionContext& QueryContext)
		{
			...
			UMassTrafficSubsystem& MassTrafficSubsystem = QueryContext.GetMutableSubsystemChecked<UMassTrafficSubsystem>(World);
