...
void UMassTrafficSubsystem::GetAllObstacleLocations(TArray<FVector> & ObstacleLocations)
{
	...
	ObstacleEntityQuery.ForEachEntityChunk(*EntityManager.Get(), ExecutionContext, [&ObstacleLocations](FMassExecutionContext& QueryContext)
	{
...
void UMassTrafficSubsystem::GetPlayerVehicleAgents(TArray<FMassEntityHandle>& OutPlayerVehicleAgents)
{
	FMassExecutionContext ExecutionContext(EntityManager, 0.0f);
	check(EntityManager);
	PlayerVehicleEntityQuery.ForEachEntityChunk(*EntityManager.Get(), ExecutionContext, [&OutPlayerVehicleAgents](FMassExecutionContext& QueryContext)
	{
